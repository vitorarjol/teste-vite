...
<body class="antialiased">
    ...
    @env('local')
    <script type="module"
            src="http://localhost:3000/@vite/client"></script>
    <script type="module"
            src="http://localhost:3000/resources/js/app.js"></script>
    @endenv

    @production
    @if(isset($manifest['style.css']))
    <link rel="stylesheet"
          href="/assets/{{ $manifest['style.css'] }}">
    @endif

    <script type="module"
            src="{{ asset($manifest['resources/js/vitor.js']['file']) }}"></script>
    @endproduction
</body>
